...
export const COVER_STICKERS = [
  ...
  // ملصقات على طراز عناوين الكتب (Book-title style)
  { id: 'txt_ch1',      type: 'text', text: 'Chapter One',       price: 15, name: 'Chapter One',       nameAr: 'الفصل الأول' },
  { id: 'txt_begins',   type: 'text', text: 'The Adventure Begins', price: 25, name: 'The Adventure Begins', nameAr: 'المغامرة تبدأ' },
  { id: 'txt_continued',type: 'text', text: 'To Be Continued',   price: 20, name: 'To Be Continued',   nameAr: 'يتبع' },
  { id: 'txt_bestseller',type: 'text', text: 'Best Seller',      price: 30, name: 'Best Seller',       nameAr: 'الأكثر مبيعًا' },
  { id: 'txt_vol1',     type: 'text', text: 'Vol. I',            price: 15, name: 'Volume I',          nameAr: 'الجزء الأول' },
  { id: 'txt_bibo',     type: 'text', text: 'A Bibo Story',      price: 25, name: 'A Bibo Story',      nameAr: 'قصة من بيبو' },
];
